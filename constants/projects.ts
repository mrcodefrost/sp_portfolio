...
export const PROJECTS: Project[] = [
  {
    ...
    tech: "Next.js, TypeScript, Tailwind CSS, Node.js, PostgreSQL, Sanity CMS, Razorpay, PostHog",
    category: "web",
    highlights: [
      ...
      "Sanity CMS-powered blog on a Next.js, Node.js, PostgreSQL stack",
    ],
  ...
  },
  {
    ...
    tech: "Next.js, TypeScript, Tailwind CSS, Node.js, PostgreSQL, Razorpay, WhatsApp API",
    category: "web",
    highlights: [
  ...
  },
  {
    ...
    tech: "Flutter, Firebase, Figma, Postman, Spring Boot, Apache Tomcat",
    category: "mobile",
    highlights: [
  ...
  },
  {
    ...
    tech: "Next.js, TypeScript, Tailwind CSS, Node.js, PostgreSQL, GitHub, LeetCode, Razorpay, AWS SES, AWS S3, Railway",
    category: "web",
    highlights: [
  ...
  {
    src: "/wherePeriGoesCoverPic.png",
    title: "Where Peri Goes",
    subtitle: "Travel Blog & Itinerary Store",
    tech: "Next.js, Sanity CMS, Razorpay, Paddle, Upstash, Resend, Vercel, Vercel Analytics",
    category: "web",
    highlights: [
      "Razorpay for INR and Paddle for USD enable itinerary sales to domestic and international travelers",
      "Upstash records payments, while Resend delivers each itinerary after a successful purchase",
      "Sanity CMS gives the creator control over blogs, itineraries, travel tips, and destinations",
    ],
    linkAUrl: "https://whereperigoes.com/",
    linkAText: "Visit Site",
  },
  {
  ...
  },
  {
    ...
    tech: "Flutter, Firebase, .NET, AWS, Microsoft OAuth",
    category: "mobile",
    highlights: [
  ...
  },
  {
    ...
    tech: "Flutter, Firebase, Node.js, AWS, PayPal, Stripe",
    category: "mobile",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Sanity CMS-powered blog on a reusable, component-driven Next.js/Framer Motion design system",
    ],
    linkAUrl: "https://synradlabs.com/",
    linkAText: "Visit Site",
  },
  {
    src: "/restrovateCoverPic.png",
    title: "Restrovate",
    subtitle: "F&B Agency",
    tech: "Next.js, Netlify",
    category: "web",
    highlights: [
      "Responsive agency website presenting services for restaurant brands",
      "Clear service discovery across consulting, marketing, design, and technology",
      "Built with Next.js and deployed on Netlify",
    ],
    linkAUrl: "https://restrovate.com/",
    linkAText: "Visit Site",
  },
  {
    ...
    tech: "Next.js, Tailwind CSS, Framer Motion, Sanity CMS, PostHog, Vercel",
    category: "web",
    highlights: [
  ...
  },
  {
    ...
    tech: "Flutter, Arduino, C++, Bluetooth Low Energy",
    category: "mobile",
  ...
  },
  {
    ...
    tech: "Flutter, Firebase, .NET, AWS, AuthBridge, Google Cloud",
    category: "mobile",
    highlights: [
